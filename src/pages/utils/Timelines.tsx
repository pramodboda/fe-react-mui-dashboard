...
const FE_React_Dev_Roadmap = {
    ...
    buildAndDeploymentTools:[{title:"Webpack / Vite", description:"(Tree Shaking, Code Splitting)"}, {title:"Babel", description:"(Transpiling Modern JS)"}, {title:"Package Managers", description:"(npm, yarn, pnpm)"}, {title:"CI/CD Tools", description:"(GitHub Actions, Jenkins)"}]
}
